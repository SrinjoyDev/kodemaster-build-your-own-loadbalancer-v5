...
httpClient.interceptors.response.use(
    ...
    //failure -> decide to retry or not
    async (error : AxiosError) => {
        //access original reequest config
        ...
        //initialise retry conunter on first failure
        ...
        if(shouldRetry && config.retryCount < MAX_RETRIES) {
            ...
            //re run original requests with updated retry counter.
